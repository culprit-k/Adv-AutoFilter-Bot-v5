...
async def start(bot, cmd):
    ...
    if usr_cmdall1.startswith("/start subinps"):
        ...
        await cmd.reply_photo(
            ...
            caption="""<b>𝑯𝒆𝒚 👋 {}😍</b>
<b>ഞാൻ ഒരു 𝘼𝙪𝙩𝙤 𝙁𝙞𝙡𝙩𝙚𝙧 ബോട്ട് ആണ്, എന്നെ നിങ്ങളുടെ ഗ്രൂപ്പിൽ ആഡ് ചെയ്യാൻ നോക്കി സമയം കളയണ്ട, എന്നെ 𝕄𝕆𝕍𝕀𝔼 ℍ𝕆𝕌𝕊𝔼 𝔼ℕ𝕋𝔼ℝ𝕋𝔸𝕀ℕ𝕄𝔼ℕ𝕋𝕊 ഗ്രൂപ്പിൽ മാത്രമേ ആഡ് ചെയ്യാൻ കഴിയൂ...!!!
